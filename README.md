...
- `scenarios/` — место для будущего контента.
...
реальное соединение с PostgreSQL. Playwright предусмотрен в плане, но будет
добавлен вместе с игровыми E2E-сценариями.
