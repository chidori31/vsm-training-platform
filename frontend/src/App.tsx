          ...
          <div className="connection-notice" role="alert">
            <div>
              ...
              {runner.pendingChoiceId && (
                <p>
                  Проверим, принято ли последнее действие. Повторно выбирать его
                  не нужно.
                </p>
              )}
            </div>
              ...
              <div className="departure-board">
                <div className="briefing-preview">
                  ...
                  <div className="briefing-art">
                    ...
                    <span className="window-caption">ВСМ / УЧЕБНЫЙ ВАГОН</span>
                  </div>
                </div>
                <div className="departure-controls">
                  <fieldset disabled={runner.busy}>
                    ...
                    {runner.catalog.map((scenario, index) => {
                      ...
                      return (
                        ...
                        >
                          <span className="departure-index" aria-hidden="true">
                            {String(index + 1).padStart(2, "0")}
                          </span>
                  ...
                  <div className="departure-action">
                    ...
                    <button
                      ...
                      disabled={runner.busy || runner.connection !== "online"}
        ...
        {state && session && scene && !completed && (
          <>
            ...
            <div className="operating-stage">
              ...
              <aside className="instruments" aria-label="Показатели и время">
                <div
                ...
                >
                  <span className="micro-label">
                    {seconds === null ? "СПОКОЙНЫЙ ТЕМП" : "ВРЕМЯ НА РЕШЕНИЕ"}
                  </span>
                  <strong>
                    {seconds === null
                      ? "—:—"
            ...
            {lastDecision && (
              <DecisionFeedback key={lastDecision.id} decision={lastDecision} />
            )}
            <section
          ...
          <div className="completion">
            ...
            <div className="result-overview">
              <div className="result-copy">
                ...
                <p>{state.current_node.text}</p>
                <span className="quiet-note">
                  Доверие и безопасность оцениваются независимо. Разберите, как
                  каждое решение повлияло на результат.
                </span>
              </div>
              <Scoreboard session={session} />
            </div>
                    ...
                    <div>
                      ...
                      <div className="change-list">
                        {decision.score_changes
                          .filter((change) => change.metric !== "competency")
                          .map((change) => (
                            <span
                              className={
